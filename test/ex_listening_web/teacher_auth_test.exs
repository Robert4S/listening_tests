defmodule ExListeningWeb.TeacherAuthTest do
  use ExListeningWeb.ConnCase

  alias Phoenix.LiveView
  alias ExListening.Teachers
  alias ExListeningWeb.TeacherAuth
  ...
  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, ExListeningWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_teacher/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      ExListeningWeb.Endpoint.subscribe(live_socket_id)
